...
//		customer.setJobs("teacher");
        ...
        List<Customer> customers = session.selectList("com.cc.mapper"
...
//	    customer.setJobs("teacher");
        // 执行SqlSession的查询方法，返回结果集
        List<Customer> customers = session.selectList("com.zxt.mapper"
    ...
    public void updateCustomerTest() {
        ...
        int rows = sqlSession.update("com.zxt.mapper"
